...
export default function EventFilters({ lang, isOpen, setIsOpen }: EventFiltersProps) {
  ...
  // When open, the component takes full width, pushing other items to the next line.
  const containerWidthClass = isOpen ? 'w-full' : 'w-auto';
  ...
  return (
    <div className={containerWidthClass}>
      ...
      {isOpen && (
        // This div is no longer absolutely positioned. It's now in the document flow.
        <div className="mt-2 w-full">
          <div className="card bg-base-200 shadow-xl">
            <div className="card-body p-4">
              {/* This grid makes the filter inputs responsive */}
