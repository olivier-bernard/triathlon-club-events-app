    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-2 w-64">
                ...
                <input name="displayName" placeholder="Preferred display name" className="border px-2 py-1 rounded" required />
                <input name="email" type="email" placeholder="Email (optional, for notifications)" className="border px-2 py-1 rounded" />
